/**
 * Daily verse rotation — port từ apps/web/src/data/verses.ts (cùng list 30
 * câu, cycle theo day-of-year để mobile + web hiện cùng câu một ngày).
 * Source: BTTHĐ 2011 (CLAUDE.md C4 canonical).
 */
