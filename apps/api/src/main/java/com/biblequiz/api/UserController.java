...
public class UserController {
    ...
    public ResponseEntity<?> getTierProgress(Authentication authentication) {
        ...
        // XP surge info — Milestone Burst (SPEC_USER §4.7, BL-3 wired 2026-05-13).
        // surgeActive=true when User.xpSurgeUntil > now. While active, all Ranked
        // points are multiplied ×1.5 in RankedController.submitRankedAnswer via
        // ScoringService.calculateWithTier(..., xpSurgeActive). FE consumes via
        // MilestoneBanner.SurgeCountdown.
        LocalDateTime surgeUntil = userOpt.get().getXpSurgeUntil();
