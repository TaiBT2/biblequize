...
public class JwtService {
    ...
    // Overload for convenience when only username/email is available
    public String generateToken(String username) {
        return buildTokenForSubject(username, jwtExpiration);
    }
    ...
    public String generateRefreshToken(String username) {
        return buildTokenForSubject(username, refreshExpiration);
    }
