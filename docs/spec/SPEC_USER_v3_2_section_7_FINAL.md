# SPEC_USER §7 — Question Selection System

> **Status:** READY TO MERGE 2026-05-21 — Bui approved v3 with 2 micro nits (M1/M2 fixed in this revision)
...
>
> **Changelog v1 → v2 → v3 → v3.1:**
> - v1 (2026-05-21): initial draft
> - v2: 11 fixes (B1-B2 PK convention, I1-I4 inconsistencies, G1-G5 gaps)
> - v3: 7 nits (N1 season_id BIGINT→VARCHAR(36) verified via Season.java, N2 INSERT id column, N3 MySQL multi-drop syntax, N4 current_difficulty timing split, N5 throttle coverage_book_ticked event, N6 FK/index pre-check before rename, N7 resolve §7.14 open questions)
> - v3.1 (this): 2 micro nits (M1 UUID version drift acknowledgment, M2 coverage_book_ticked property rename count_at_tick → total_answered_in_book). M3 BACKLOG entry handed off separately.
