...
- LBG-1 BE: PublicLeaderboardController
  - Status: [ ] TODO · Files: `apps/api/.../api/PublicLeaderboardController.java`, test · Test: @WebMvcTest slice (guest 200)
...
- LBG-2 FE: Leaderboard.tsx guest-aware
  - Status: [ ] TODO · Files: `apps/web/src/pages/Leaderboard.tsx` · Test: Vitest (LBG-3)
...
- LBG-3 FE: Leaderboard guest tests
  - Status: [ ] TODO · Files: `apps/web/src/pages/__tests__/Leaderboard.test.tsx` · Test: Vitest
...
- LBG-4 FE: LandingPage scroll-to + real preview data
  - Status: [ ] TODO · Files: `apps/web/src/pages/LandingPage.tsx` · Test: Vitest (LandingPage.test)
